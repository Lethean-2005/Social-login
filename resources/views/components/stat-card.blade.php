@props(['icon' => 'users', 'label' => '', 'value' => '', 'color' => 'indigo'])
...
<div class="bg-white rounded-lg shadow p-5 flex items-center gap-4">
    ...
    <div class="min-w-0">
        ...
        <div class="mt-0.5 text-2xl font-bold text-gray-900 truncate">{{ $value }}</div>
    </div>
</div>
